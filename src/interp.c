...
/*	{ "dwalk",				do_dream_walk,		P_SLEEP,	0, L_NRM, 1, B|C|G|H, 		FA}, */
	...
	{	"aura",				do_auspex2,			P_REST,		0,	L_NRM,	1,	B|C|G,	VA|FA },
	{	"spirittouch",		do_auspex3,			P_REST,		0,	L_NRM,	1,	B|C|G|H,	VA },
	{	"kenobject",		do_auspex3,			P_REST,		0,	L_NRM,	1,	B|C|G|H,	FA },
	...
	{	"glamour",			do_blood,			P_SLEEP,	0,	L_NRM,	1,	A|B|E,	FA },
	...
	{	"unseen",			do_obfuscate2,		P_REST,		0,	L_NRM,	1,	B|C|G,	VA|WW|FA },
	{	"mask",				do_obfuscate3,		P_REST,		0,	L_NRM,	1,	B|C|D|G,	VA|FA },
